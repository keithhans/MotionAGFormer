...
def get_pose2D_coco(coco_path, output_dir):
    
    print('\nConverting 2D pose...')
    keypoints, scores = process_json(coco_path)
    keypoints, scores, valid_frames = h36m_coco_format(keypoints, scores)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--coco', type=str, default='', help='input coco 2d keypoints json. Generated by mmpose.')
    ...
    if args.coco:
        get_pose2D_coco(args.coco, output_dir)
    else:
